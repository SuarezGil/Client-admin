...
import { Spinner } from "../../../shared/components/layaout/Spinner.jsx";
...
export const Users = () => {
    ...
    const filteredUsers = useMemo(() => {
        ...
        return users.filter((u) => {
            ...
            const matchesSearch = !normalizedSearch || fullName.includes(normalizedSearch) || username.includes(normalizedSearch);
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-t bg-gray-50">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button 
                        onClick ={() => setPage(() => Math.min(totalPages, p + 1))}
